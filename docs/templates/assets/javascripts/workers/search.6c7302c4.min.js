...
`,
          ...
          for (
            ...
            for (
              ...
              for (var l = s[c], g = 0; g < u; g++) {
                var f = a[g];
                if (f == l || l == "*") {
                  var x = n.node.edges[f],
                    m = n.qNode.edges[l],
                    v = x.final && m.final,
                    d = void 0;
                  f in n.output.edges
                    ? ((d = n.output.edges[f]), (d.final = d.final || v))
                    : ((d = new t.TokenSet()),
                      (d.final = v),
                      (n.output.edges[f] = d)),
                    i.push({ qNode: m, output: d, node: x });
                }
              }
          }
          return r;
        ...
        (t.Index.prototype.query = function (e) {
          ...
          for (var u = 0; u < r.clauses.length; u++) {
            var c = r.clauses[u],
              ...
              g = t.Set.empty;
            c.usePipeline
              ? (l = this.pipeline.runString(c.term, { fields: c.fields }))
              : (l = [c.term]);
            for (var f = 0; f < l.length; f++) {
              var x = l[f];
              c.term = x;
              var m = t.TokenSet.fromClause(c),
                v = this.tokenSet.intersect(m).toArray();
          ...
          for (
            var j = t.Set.complete, I = t.Set.empty, u = 0;
            u < this.fields.length;
            u++
          ) {
            var y = this.fields[u];
            o[y] && (j = j.intersect(o[y])), a[y] && (I = I.union(a[y]));
          }
          var h = Object.keys(n),
            S = [],
    ...
    return t.map((i, s) => {
      ...
      for (let [u, c] of o) {
        let l = e[u],
          g = l[0] >>> 12,
          f = l[l.length - 1] >>> 12,
          x = (l[l.length - 1] >>> 2) & 1023,
          m = i.slice(g, f + x);
        for (let v of c.sort((d, y) => y - d)) {
          let d = (l[v] >>> 12) - g,
            y = ((l[v] >>> 2) & 1023) + d;
          m = [
            m.slice(0, d),
        ...
        switch ((i[(l = o += s)] || (i[l] = []), a)) {
          ...
          case 1:
            ...
            H(g, lunr.tokenizer.separator, (f, x) => {
              ...
              i[o].push(((u + f) << 12) | ((x - f) << 2) | a),
                e.push(
                  new lunr.Token(g.slice(f, x).toLowerCase(), {
                    position: (o << 20) | (i[o].length - 1),
                  })
                );
            });
            ...
            if (typeof c != "undefined") {
              ...
              for (let f of this.index.fields) {
                ...
                for (let d of Object.values(u.metadata))
                  typeof d[f] != "undefined" && x.push(...d[f].position);
                if (!x.length) continue;
                let m = this.table.get([c.location, f].join(":")),
                  v = Array.isArray(c[f]) ? q : se;
                c[f] = v(c[f], m, x);
              }
              let g =
                +!c.parent +
              ...
              s.push(B(_({}, c), { score: a * (1 + Z(g, 2)), terms: l }));
            }
            return s;
          }, [])
  ...
  function Fe(t) {
    return W(this, null, function* () {
      switch (t.type) {
        case 0:
          return yield Ie(t.data.config), (fe = new U(t.data)), { type: 1 };
        case 2:
          let e = t.data;
          try {
