...
(() => {
  ...
  var fn = (e, t, r) =>
      t in e
        ...
        : (e[t] = r),
    j = (e, t) => {
      for (var r in t || (t = {})) Cr.call(t, r) && fn(e, r, t[r]);
      if (qt) for (var r of qt(t)) un.call(t, r) && fn(e, r, t[r]);
      return e;
    };
  var mn = (e, t) => {
    var r = {};
    for (var n in e) Cr.call(e, n) && t.indexOf(n) < 0 && (r[n] = e[n]);
    if (e != null && qt)
      for (var n of qt(e)) t.indexOf(n) < 0 && un.call(e, n) && (r[n] = e[n]);
    return r;
  };
  var Kt = (e, t) => () => (
  ...
  var hn = Kt((kr, dn) => {
    (function (e, t) {
      typeof kr == "object" && typeof dn != "undefined"
        ? t()
      ...
      function e(r) {
        ...
        function p(M) {
          var Ne = M.type,
            R = M.tagName;
          return !!(
            (R === "INPUT" && a[Ne] && !M.readOnly) ||
            (R === "TEXTAREA" && !M.readOnly) ||
            M.isContentEditable
          );
        }
        function c(M) {
      ...
      var t = function () {
        ...
        a = function () {
          var c = function (f) {
              ...
              var m = typeof f;
              if (m !== "undefined")
                if (m === "string") f !== "" && this._fromString(f);
            ...
            (l.forEach = function (f, m) {
              ...
              for (var h in this._entries)
                if (this._entries.hasOwnProperty(h)) {
                  d = this._entries[h];
                  for (var v = 0; v < d.length; v++) f.call(m, d[v], h, this);
                }
            }),
            (l.keys = function () {
              var f = [];
      ...
      typeof p.sort != "function" &&
        (p.sort = function () {
          var c = this,
            l = [];
          this.forEach(function (m, d) {
            l.push([d, m]), c._entries || c.delete(d);
          }),
            l.sort(function (m, d) {
              return m[0] < d[0] ? -1 : m[0] > d[0] ? 1 : 0;
            }),
            c._entries && (c._entries = {});
          for (var f = 0; f < l.length; f++) this.append(l[f][0], l[f][1]);
        }),
          ...
          Object.defineProperty(p, "_fromString", {
            ...
            value: function (c) {
              if (this._entries) this._entries = {};
                ...
                for (var f = 0; f < l.length; f++) this.delete(l[f]);
              }
              c = c.replace(/^\?/, "");
        ...
        r = function () {
          var o = e.URL,
            i = function (p, c) {
              ...
              (m.href = p), f && (l.body.appendChild(m), (m.href = m.href));
          ...
          ["hash", "host", "hostname", "port", "protocol"].forEach(function (
            ...
            Object.defineProperties(a, {
              ...
              origin: {
                get: function () {
                  var p = { "http:": 80, "https:": 443, "ftp:": 21 }[
  ...
  var nn = Kt((Ut, rn) => {
    (function (t, r) {
      typeof Ut == "object" && typeof rn == "object"
        ? (rn.exports = r())
        : typeof define == "function" && define.amd
        ? define([], r)
        : typeof Ut == "object"
        ...
        var e = {
            686: function (n, o, i) {
              ...
              var Ne = function () {
                  ...
                  if (Pe) return K(Pe, { container: U });
                  if (G) return I === "cut" ? h(G) : K(G, { container: U });
                },
                R = Ne;
              function B(D) {
                "@babel/helpers - typeof";
              ...
              function Ee(D, A, L) {
                return A && me(D.prototype, A), L && me(D, L), D;
              }
              function Be(D, A) {
              ...
              function $i(D, A) {
                return A && (B(A) === "object" || typeof A == "function")
                  ? A
                  : Pi(D);
              }
              function Pi(D) {
              ...
              function Lr(D, A) {
                ...
                if (A.hasAttribute(L)) return A.getAttribute(L);
              }
              var ji = (function (D) {
                  Be(L, D);
                  var A = Hi(L);
                          ...
                          value: function () {
                            var U =
                              arguments.length > 0 && arguments[0] !== void 0
                                ...
                                : {};
                            (this.action =
                              typeof U.action == "function"
                                ? U.action
                                : this.defaultAction),
                              (this.target =
                                typeof U.target == "function"
                                  ? U.target
                                  : this.defaultTarget),
                              (this.text =
                                typeof U.text == "function"
                                  ? U.text
                                  : this.defaultText),
                              (this.container =
                                B(U.container) === "object"
                                  ? U.container
                                  : document.body);
                          },
                        },
            ...
            370: function (n, o, i) {
              ...
              function p(m, d, h) {
                ...
                if (a.nodeList(m)) return l(m, d, h);
                if (a.string(m)) return f(m, d, h);
                throw new TypeError(
  ...
  function gn(e, t, r) {
    ...
    function p(m) {
      m.value instanceof ct
        ? Promise.resolve(m.value.v).then(c, l)
        : f(i[0][2], m);
    }
    function c(m) {
      s("next", m);
...
` +
  ...
  var dt = {
    setTimeout: function (e, t) {
      ...
      return o != null && o.setTimeout
        ? o.setTimeout.apply(o, Q([e, t], q(r)))
        : setTimeout.apply(void 0, Q([e, t], q(r)));
    },
  ...
  var At = (function (e) {
    ...
    function t(r) {
      ...
      return (
        (n.isStopped = !1),
        r ? ((n.destination = r), Bt(r) && r.add(n)) : (n.destination = Yi),
        n
      );
    }
    return (
  ...
  var Yi = { closed: !0, next: Ce, error: Ki, complete: Ce };
  var bt = (function () {
  ...
  function _n(e) {
    var t;
    return (t = e != null ? e : Ie.Promise) !== null && t !== void 0
      ? t
      : Promise;
  }
  function Qi(e) {
      ...
      (t.prototype.next = function (r) {
        ...
        ht(function () {
          ...
          if ((n._throwIfClosed(), !n.isStopped)) {
            ...
            try {
              for (
                var a = we(n.currentObservers), s = a.next();
                !s.done;
                s = a.next()
              ) {
                var p = s.value;
  ...
  var Rt = {
    setInterval: function (e, t) {
      ...
      return o != null && o.setInterval
        ? o.setInterval.apply(o, Q([e, t], q(r)))
        : setInterval.apply(void 0, Q([e, t], q(r)));
    },
  ...
  var Xt = (function (e) {
    ...
    return (
      ...
      (t.prototype.requestAsyncId = function (r, n, o) {
        return (
          o === void 0 && (o = 0), Rt.setInterval(r.flush.bind(r, this), o)
        );
      }),
      ...
      (t.prototype.recycleAsyncId = function (r, n, o) {
        ...
        n != null &&
          ((i = a[a.length - 1]) === null || i === void 0 ? void 0 : i.id) !==
            n &&
          (vt.cancelAnimationFrame(n), (r._scheduled = void 0));
      }),
      t
    );
  })(Xt);
  ...
  function oa(e, t) {
    ...
    return vn(this, void 0, void 0, function () {
      ...
      return Yt(this, function (p) {
        switch (p.label) {
          case 0:
            p.trys.push([0, 5, 6, 11]), (r = yn(e)), (p.label = 1);
          case 1:
            return [4, r.next()];
          case 2:
          ...
          case 4:
            return [3, 11];
          case 5:
            return (s = p.sent()), (o = { error: s }), [3, 11];
          case 6:
            return (
              p.trys.push([6, , 9, 10]),
  ...
  function Fn(e, t) {
    if (e != null) {
      if (nr(e)) return Hn(e, t);
      if (gt(e)) return Pn(e, t);
      if (rr(e)) return $n(e, t);
      if (or(e)) return lr(e, t);
      if (sr(e)) return In(e, t);
      if (pr(e)) return jn(e, t);
    }
    throw ir(e);
  }
  function pe(e, t) {
  ...
  var ua = ["addListener", "removeListener"],
    ...
    da = ["on", "off"];
  function b(e, t, r, n) {
    if ((k(r) && ((n = r), (r = void 0)), n)) return b(e, t, r).pipe(rt(n));
    var o = q(
        va(e)
          ? ma.map(function (s) {
              return function (p) {
    ...
    return E(function (t, r) {
      ...
      t.subscribe(
        _(
          r,
          function (c) {
            (n = !0), (o = c), i || z(e(c)).subscribe((i = _(r, s, p)));
          },
          function () {
      ...
      E(function (r, n) {
        ...
        function p() {
          var c = a + e,
            l = t.now();
          if (l < c) {
            (o = this.schedule(void 0, c - l)), n.add(o);
            return;
          }
          s();
        }
        ...
        Ne.add(function () {
          ...
          !l &&
            ...
            ((l = new lt({
              ...
              error: function (B) {
                (v = !0), Y(), (f = Kr(X, o, B)), R.error(B);
              },
              complete: function () {
                (h = !0), Y(), (f = Kr(X, a)), R.complete();
              },
            })),
            z(M).subscribe(l));
      })(c);
    ...
    return E(function (r, n) {
      ...
      r.subscribe(
        _(
          n,
          function (X) {
            (c = !0), (l = X), !(f && !f.closed) && (a ? Y() : v(X));
          },
          function () {
            (m = !0), !(p && c && f && !f.closed) && n.complete();
          }
        )
      );
    });
  ...
  var Ea = T(b(document.body, "focusin"), b(document.body, "focusout")).pipe(
    Te(1),
    V(void 0),
    u(() => De() || document.body),
    Z(1)
  ...
  function eo(e) {
    return T(b(window, "load"), b(window, "resize")).pipe(
      Re(0, Se),
      u(() => qe(e)),
      V(qe(e))
    );
  ...
  function it(e) {
    return T(b(e, "scroll"), b(window, "resize")).pipe(
      Re(0, Se),
      u(() => dr(e)),
      V(dr(e))
    );
  ...
  function ka(e) {
    ...
    if (
      (n.boxSizing === "border-box" &&
        (Math.round(s + i) !== t && (s -= to(n, "left", "right") + i),
        Math.round(p + a) !== r && (p -= to(n, "top", "bottom") + a)),
      !Ha(e))
    ) {
      var c = Math.round(s + i) - t,
        l = Math.round(p + a) - r;
      Math.abs(c) !== 1 && (s -= c), Math.abs(l) !== 1 && (p -= l);
    }
  ...
  var Ra = (function () {
    return typeof SVGGraphicsElement != "undefined"
      ...
      : function (e) {
          return (
            e instanceof wt(e).SVGElement && typeof e.getBBox == "function"
          );
        };
  })();
  function Ha(e) {
  ...
  var co = new S(),
    Wa = P(() =>
      $(
        new so((e) => {
          for (let t of e) co.next(t);
        })
      )
    ).pipe(
      g((e) => T(Xe, $(e)).pipe(C(() => e.disconnect()))),
      Z(1)
    );
  function be(e) {
  ...
  function uo() {
    let e = b(window, "keydown").pipe(
      ...
      y(({ mode: t, type: r }) => {
        if (t === "global") {
          let n = De();
          if (typeof n != "undefined") return !Na(n, r);
        }
        return !0;
      }),
      he()
  ...
  function Xr(e) {
    return T(b(window, "hashchange"), e).pipe(
      u(bo),
      V(bo()),
      y((t) => t.length > 0),
      Z(1)
  ...
  function xr(e, t = { credentials: "same-origin" }) {
    return pe(fetch(`${e}`, t)).pipe(
      ge(() => x),
      g((r) => (r.status !== 200 ? Ht(() => new Error(r.statusText)) : $(r)))
    );
  }
  function Ye(e, t) {
    return xr(e, t).pipe(
    ...
    return P(
      () => (
        ...
        T(
          b(t, "load"),
          b(t, "error").pipe(
            g(() => Ht(() => new ReferenceError(`Invalid script: ${e}`)))
          )
        ).pipe(
          u(() => {}),
  ...
  function So() {
    return b(window, "resize", { passive: !0 }).pipe(u(wo), V(wo()));
  }
  function To() {
    return J([Eo(), So()]).pipe(
  ...
  function _e(e, t) {
    return typeof t != "undefined"
      ? _t.translations[e].replace("#", t.toString())
      : _t.translations[e];
  }
  ...
  function Ya(e) {
    ...
    return b(t, "click", { once: !0 }).pipe(
      u(() => W(".md-typeset", e)),
      u((r) => ({ hash: __md_hash(r.innerHTML) }))
    );
  }
  function _o(e) {
  ...
  function Ft(e, t) {
    return t === "inline"
      ? O(
          ...
          O("div", { class: "md-tooltip__inner md-typeset" })
        )
      : O(
          "div",
    ...
    if (((t = t ? `${t}_annotation_${e}` : void 0), t)) {
      ...
      return O(
        ...
        O(
          ...
          O("span", { "data-md-annotation-id": e })
        )
      );
    } else
      return O(
  ...
  function ko() {
    return O("nav", { class: "md-code__nav" });
  }
  function en(e, t) {
    let r = t & 2,
      n = t & 1,
    ...
    return O(
      ...
      O(
        ...
        r > 0 && O("div", { class: "md-search-result__icon md-icon" }),
        r > 0 && O("h1", null, e.title),
        r <= 0 && O("h2", null, e.title),
          ...
          e.tags.map((p) => {
            let c = s
              ? p in s
                ...
                : "md-tag-icon"
              : "";
            return O("span", { class: `md-tag ${c}` }, p);
          }),
        n > 0 &&
          o.length > 0 &&
          O(
  ...
  function Ro(e) {
                ...
                O(
                  ...
                  O(
                    ...
                    p.length > 0 && p.length === 1
                      ? _e("search.result.more.one")
                      : _e("search.result.more.other", p.length)
                  )
                ),
                ...p.map((l) => en(l, 1))
              ),
    ...
    return O("li", { class: "md-search-result__item" }, c);
  }
  function Ho(e) {
    return O(
      "ul",
  ...
  function $o(e) {
    return O(
      ...
      O("div", { class: "md-typeset__table" }, e)
    );
  }
  function Ba(e) {
    let t = ve(),
    ...
    return O(
      ...
      O("a", { href: `${r}`, class: "md-version__link" }, e.title)
    );
  }
  function Po(e, t) {
    return O(
      ...
      O(
        "button",
        { class: "md-version__current", "aria-label": _e("select.version") },
        t.title
      ),
      O("ul", { class: "md-version__list" }, e.map(Ba))
    );
  }
  var Ga = 0;
  function Ja(e, t) {
    ...
    let n = Tt(t),
      o = typeof n != "undefined" ? it(n) : $({ x: 0, y: 0 }),
  ...
  function Sr(e, t, { target$: r, print$: n }) {
    ...
    for (let s of es(t)) {
      ...
      ue(`:scope > li:nth-child(${p})`, e) &&
        (a.set(p, Lo(p, i)), s.replaceWith(a.get(p)));
    }
    return a.size === 0
      ? x
      : P(() => {
          ...
          return (
            n.pipe(F(p)).subscribe((l) => {
              (e.hidden = !l), e.classList.toggle("md-annotation-list", l);
              for (let [f, m] of c) l ? jo(f, m) : jo(m, f);
            }),
            T(...[...a].map(([, l]) => Io(l, t, { target$: r }))).pipe(
              C(() => s.complete()),
              he()
            )
          );
  ...
  function Fo(e) {
    if (e.nextElementSibling) {
      ...
      if (t.tagName === "P" && !t.children.length) return Fo(t);
    }
  }
  function Uo(e, t) {
    return P(() => {
  ...
  var ts = 0,
    Wo = T(
      b(window, "keydown").pipe(u(() => !0)),
      T(b(window, "keyup"), b(window, "contextmenu")).pipe(u(() => !1))
    ).pipe(V(!1), Z(1));
  function No(e) {
    if (e.nextElementSibling) {
      let t = e.nextElementSibling;
      if (t.tagName === "OL") return t;
      if (t.tagName === "P" && !t.children.length) return No(t);
    }
  }
  function rs(e) {
    return Le(e).pipe(
      u(({ width: t }) => ({ scrollable: St(e).width > t })),
      oe("scrollable")
    );
  }
  function zo(e, t) {
    let { matches: r } = matchMedia("(hover)"),
      n = P(() => {
        ...
        if (l instanceof HTMLElement) {
          ...
          if (
            typeof m != "undefined" &&
            (l.classList.contains("annotate") || ee("content.code.annotate"))
          ) {
            let d = Sr(m, e, t);
            c.push(
              Le(l).pipe(
                F(i),
                u(({ width: h, height: v }) => h && v),
                te(),
                g((h) => (h ? d : x))
              )
            );
        ...
        if (
          ...
          e.closest(".select") ||
            (ee("content.code.select") && !e.closest(".no-select")))
        ) {
          let m = +f[0].id.split("-").pop(),
            d = Co();
          s.push(d), ee("content.tooltips") && c.push(Qe(d));
          let h = b(d, "click").pipe(
            Pt((R) => !R, !1),
            w(() => d.blur()),
            he()
          );
          ...
          h.pipe(g((R) => (R ? v : x))).subscribe(([R, B]) => {
            ...
            if (se && !B) se.replaceWith(...Array.from(se.childNodes));
            else if (!se && B) {
          ...
          let Y = pe(f).pipe(
            ...
            X = h.pipe(
              ...
              u(([R, B]) => {
                ...
                {
                  let Ee = H(".hll", e).map(
                    (Be) => f.indexOf(Be.parentElement) + m
                  );
                  return (
                ...
                B &&
                  setTimeout(() => {
                    ...
                    for (; se !== document.body; )
                      (me += se.offsetTop), (se = se.offsetParent);
                    window.scrollTo({ top: me });
                  }, 1);
              }
            });
          let Ne = pe(H('a[href^="#__codelineno"]', l))
            .pipe(
              re((R) =>
                b(R, "click").pipe(
                  w((B) => B.preventDefault()),
            ...
            .pipe(
              ...
              ie(Wo),
              u(([R, B]) => {
                let me = +W(`[id="${R.hash.slice(1)}"]`)
                  .parentElement.id.split("-")
                  .pop();
                if (B === !1) return [me, me];
                {
                  let Ee = H(".hll", e).map(
                    (Be) => +Be.parentElement.id.split("-").pop()
                  );
        ...
        if (
          Do.default.isSupported() &&
          (e.closest(".copy") ||
            (ee("content.code.copy") && !e.closest(".no-copy")))
        ) {
          let m = Ao(p.id);
          s.push(m), ee("content.tooltips") && c.push(Qe(m));
        }
        if (s.length) {
          let m = ko();
          m.append(...s), p.insertBefore(m, e);
        }
        return rs(e).pipe(
          w((m) => o.next(m)),
          C(() => o.complete()),
  ...
  function ns(e, { target$: t, print$: r }) {
    ...
    return T(
      t.pipe(
        ...
        y((o) => e === o),
        u(() => ({ action: "open", reveal: !0 }))
      ),
      r.pipe(
        y((o) => o || !n),
        w(() => (n = e.open)),
        u((o) => ({ action: o ? "open" : "close" }))
      )
    );
  }
  function Vo(e, t) {
  ...
  function as() {
    return typeof mermaid == "undefined" || mermaid instanceof Element
      ? Er("https://unpkg.com/mermaid@9.4.3/dist/mermaid.min.js")
      : $(void 0);
  }
  function Ko(e) {
    return (
      ...
      on.subscribe(() => {
        ...
        let t = `__mermaid_${is++}`,
          r = O("div", { class: "mermaid" }),
          n = e.textContent;
        mermaid.mermaidAPI.render(t, n, (o, i) => {
          let a = r.attachShadow({ mode: "closed" });
  ...
  var Yo = O("table");
  function Qo(e) {
    return e.replaceWith(Yo), Yo.replaceWith($o(e)), $({ ref: e });
  }
  function ss(e) {
    let t = e.find((r) => r.checked) || e[0];
    return T(
      ...e.map((r) => b(r, "change").pipe(u(() => W(`label[for="${r.id}"]`))))
    ).pipe(
      V(W(`label[for="${t.id}"]`)),
      u((r) => ({ active: r }))
    );
      ...
      P(() => {
        ...
        J([s, Le(e)])
          ...
          .subscribe({
            next([{ active: c }, l]) {
              ...
              let d = dr(n);
              (f.x < d.x || f.x + m > d.x + l.width) &&
                n.scrollTo({ left: Math.max(0, f.x - 16), behavior: "smooth" });
            },
            complete() {
          ...
          T(b(i, "click").pipe(u(() => -1)), b(a, "click").pipe(u(() => 1)))
            .pipe(F(p))
            .subscribe((c) => {
              let { width: l } = be(n);
              n.scrollBy({ left: l * c, behavior: "smooth" });
            }),
          r
            .pipe(
              F(p),
        ...
        for (let c of o) {
          ...
          l.replaceChildren(
            ...
            b(l.firstElementChild, "click")
              .pipe(
                F(p),
                y((f) => !(f.metaKey || f.ctrlKey)),
                w((f) => f.preventDefault())
              )
              .subscribe(() => {
        ...
        return (
          ee("content.tabs.link") &&
            s.pipe(Oe(1), ie(t)).subscribe(([{ active: c }, { offset: l }]) => {
              ...
              if (c.hasAttribute("data-md-switching"))
                ...
                window.scrollTo({ top: e.offsetTop - m });
                let d = __md_get("__tabs") || [];
                __md_set("__tabs", [...new Set([f, ...d])]);
              }
            }),
          s.pipe(F(p)).subscribe(() => {
            for (let c of H("audio, video", e)) c.pause();
          }),
          ss(o).pipe(
            w((c) => s.next(c)),
            C(() => s.complete()),
  ...
  function Go(e, { viewport$: t, target$: r, print$: n }) {
    return T(
      ...H(".annotate:not(.highlight)", e).map((o) =>
        Uo(o, { target$: r, print$: n })
      ),
      ...H("pre:not(.mermaid) > code", e).map((o) =>
        zo(o, { target$: r, print$: n })
      ),
      ...H("pre.mermaid", e).map((o) => Ko(o)),
      ...H("table:not([class])", e).map((o) => Qo(o)),
      ...H("details", e).map((o) => Vo(o, { target$: r, print$: n })),
      ...H("[data-tabs]", e).map((o) => Bo(o, { viewport$: t, target$: r })),
      ...H("[title]", e)
        .filter(() => ee("content.tooltips"))
        .map((o) => Qe(o))
    );
  }
  function cs(e, { alert$: t }) {
    return t.pipe(
      g((r) =>
        T($(!0), $(!1).pipe(Ze(2e3))).pipe(
          u((n) => ({ message: r, active: n }))
        )
      )
    );
  }
  ...
  function ps({ viewport$: e }) {
    ...
    let t = e.pipe(
      ...
      r = J([e, t]).pipe(
        y(([{ offset: o }, [, i]]) => Math.abs(i - o.y) > 100),
        u(([, [o]]) => o),
        te()
      ),
      n = Ke("search");
  ...
  function Xo(e, t) {
    return P(() => J([Le(e), ps(t)])).pipe(
      u(([{ height: r }, n]) => ({ height: r, hidden: n })),
      te((r, n) => r.height === n.height && r.hidden === n.hidden),
      Z(1)
    );
  }
  function Zo(e, { header$: t, main$: r }) {
    return P(() => {
      let n = new S(),
        o = n.pipe(ne(), ae(!0));
      n.pipe(oe("active"), ot(t)).subscribe(
        ([{ active: a }, { hidden: s }]) => {
          e.classList.toggle("md-header--shadow", a && !s), (e.hidden = s);
        }
      );
      let i = pe(H("[title]", e)).pipe(
        y(() => ee("content.tooltips")),
        re((a) => Qe(a))
      );
      return (
        r.subscribe(n),
  ...
  function ls(e, { viewport$: t, header$: r }) {
    return wr(e, { viewport$: t, header$: r }).pipe(
      u(({ offset: { y: n } }) => {
        let { height: o } = be(e);
        return { active: n >= o };
      }),
  ...
  function Tr(e) {
    ...
    {
      let r = ve();
      return yo(new URL("sitemap.xml", e || r.base)).pipe(
        u((n) => ms(H("loc", n).map((o) => o.textContent))),
        ge(() => x),
        Fe([]),
  ...
  function oi({ location$: e, viewport$: t }) {
    let r = ve();
    if (location.protocol === "file:") return x;
    let n = Tr().pipe(u((c) => c.map((l) => `${new URL(l, r.base)}`))),
      o = b(document.body, "click").pipe(
        ie(n),
        g(([c, l]) => {
          if (!(c.target instanceof Element)) return x;
          let f = c.target.closest("a");
          if (f === null) return x;
          if (f.target || c.metaKey || c.ctrlKey) return x;
          let m = new URL(f.href);
          return (
            (m.search = m.hash = ""),
            l.includes(`${m}`) ? (c.preventDefault(), $(new URL(f.href))) : x
          );
        }),
        he()
      );
          ...
          return Ve(H("script", f)).pipe(
            g((m) => {
              ...
              if (m.src) {
                ...
                return (d.textContent = m.textContent), m.replaceWith(d), x;
            }),
            ne(),
            ae(l)
          );
    ...
    return (
      b(window, "popstate").pipe(u(xe)).subscribe(e),
      e
        .pipe(
          V(xe()),
          je(2, 1),
          g(([c, l]) =>
            c.pathname === l.pathname && c.hash !== l.hash ? $(l) : x
          )
        )
        .subscribe((c) => {
          var l, f;
          history.state !== null || !c.hash
            ? window.scrollTo(
                0,
                (f = (l = history.state) == null ? void 0 : l.y) != null ? f : 0
              )
            : ((history.scrollRestoration = "auto"),
              Jr(c.hash),
              (history.scrollRestoration = "manual"));
  ...
  function pi(e, t) {
    let r = Oo(e);
    return (
      T($(location.protocol !== "file:"), Ke("search"))
        .pipe(
          Ue((n) => n),
          g(() => t)
        )
        .subscribe(({ config: n, docs: o }) =>
          r.next({
            ...
            data: {
              config: n,
              docs: o,
              options: { suggest: ee("search.suggest") },
            },
          })
        ),
      r
    ...
    r
      ...
      e.pipe(g(() => n)).subscribe((o) => {
        ...
        if (i === null) {
          i = !0;
          let s = [
            ((a = t.version) == null ? void 0 : a.default) || ["latest"],
          ].flat();
          e: for (let p of s)
        ...
        if (i) for (let s of le("outdated")) s.hidden = !1;
      });
  }
  function gs(e, { worker$: t }) {
    ...
    let n = Et(e),
      o = T(t.pipe(Ue(Wt)), b(e, "keyup"), n).pipe(
        u(() => e.value),
        te()
      );
    return J([o, n]).pipe(
      u(([i, a]) => ({ value: i, focus: a })),
      Z(1)
    );
  }
  ...
  function ui(e, { worker$: t, query$: r }) {
    ...
    Ke("search").subscribe((l) =>
      s.setAttribute("role", l ? "list" : "presentation")
    ),
      n
        .pipe(ie(r), Yr(t.pipe(Ue(Wt))))
        .subscribe(([{ items: l }, { value: f }]) => {
          switch (l.length) {
            case 0:
              a.textContent = f.length
                ? _e("search.result.none")
                : _e("search.result.placeholder");
              break;
            case 1:
  ...
  function di(e, { worker$: t, keyboard$: r }) {
    let n = new S(),
      o = Ae("search-query"),
      i = T(b(o, "keydown"), b(o, "focus")).pipe(
        ke(ce),
        u(() => o.value),
        te()
      );
  ...
  function hi(e, { index$: t, keyboard$: r }) {
    ...
    try {
      ...
      b(e, "click")
        .pipe(y(({ target: p }) => p instanceof Element && !!p.closest("a")))
        .subscribe(() => et("search", !1)),
      ...
      let s = fi(i, { worker$: o });
      return T(s, ui(a, { worker$: o, query$: s })).pipe(
        We(
          ...le("search-share", e).map((p) => mi(p, { query$: s })),
          ...le("search-suggest", e).map((p) =>
            di(p, { worker$: o, keyboard$: r })
          )
        )
      );
    } catch (o) {
  ...
  function bi(e, { index$: t, location$: r }) {
    return J([
      ...
      r.pipe(
        V(xe()),
        y((n) => !!n.searchParams.get("h"))
      ),
    ]).pipe(
      u(([n, o]) => ci(n.config)(o.searchParams.get("h"))),
      u((n) => {
        var a;
        let o = new Map(),
          ...
          for (let l of H(".md-nav__link--active[href]", e)) {
            ...
            if (typeof f != "undefined") {
              let m = l.offsetTop - f.offsetTop,
                { height: d } = be(f);
              f.scrollTo({ top: m - d / 2 });
            }
          }
        }),
        pe(H("label[tabindex]", e))
          .pipe(
            re((l) =>
              b(l, "click").pipe(
                u(() => l),
          ...
          .subscribe((l) => {
            ...
            W(`[aria-labelledby="${l.id}"]`).setAttribute(
              "aria-expanded",
              `${f.checked}`
            );
          }),
  ...
  function vi(e, t) {
    if (typeof t != "undefined") {
      ...
      return $t(
        Ye(`${r}/releases/latest`).pipe(
          ge(() => x),
          u((n) => ({ version: n.tag_name })),
          Fe({})
        ),
        Ye(r).pipe(
          ge(() => x),
          u((n) => ({ stars: n.stargazers_count, forks: n.forks_count })),
          Fe({})
        )
      ).pipe(u(([n, o]) => j(j({}, n), o)));
    } else {
      ...
      return Ye(r).pipe(
        u((n) => ({ repositories: n.public_repos })),
        Fe({})
      );
    }
  }
  function gi(e, t) {
    ...
    return Ye(r).pipe(
      ge(() => x),
      u(({ star_count: n, forks_count: o }) => ({ stars: n, forks: o })),
      Fe({})
    );
  }
  function yi(e) {
    ...
    return (
      ...
      (Es = P(() => {
        ...
        if (le("consent").length) {
          ...
          if (!(n && n.github)) return x;
        }
        return yi(e.href).pipe(
          w((n) => __md_set("__source", n, sessionStorage))
        );
      }).pipe(
        ge(() => x),
        y((t) => Object.keys(t).length > 0),
        u((t) => ({ facts: t })),
        Z(1)
      ))
    );
  ...
  function Ss(e, { viewport$: t, header$: r }) {
    return Le(document.body).pipe(
      g(() => wr(e, { header$: r, viewport$: t })),
      u(({ offset: { y: n } }) => ({ hidden: n >= 10 })),
      oe("hidden")
    );
  }
  function Ei(e, t) {
    return P(() => {
      ...
      return (
        ...
        (ee("navigation.tabs.sticky") ? $({ hidden: !1 }) : Ss(e, t)).pipe(
          w((n) => r.next(n)),
          C(() => r.complete()),
          u((n) => j({ ref: e }, n))
        )
  ...
  function Ts(e, { viewport$: t, header$: r }) {
    ...
    return Le(document.body)
          ...
          P(() => {
            ...
            return $(
              [...n].reduce((c, [l, f]) => {
                for (
                  ;
                  p.length && n.get(p[p.length - 1]).tagName >= f.tagName;

                )
                  p.pop();
                let m = f.offsetTop;
                for (; !m && f.parentElement; )
                  (f = f.parentElement), (m = f.offsetTop);
            ...
            u((p) => new Map([...p].sort(([, c], [, l]) => c - l))),
            ot(i),
            g(([p, c]) =>
              t.pipe(
                Pt(
                  ([l, f], { offset: { y: m }, size: d }) => {
                    let h = m + d.height >= Math.floor(s.height);
                    for (; f.length; ) {
                      let [, v] = f[0];
                      if (v - c < m || h) l = [...l, f.shift()];
                      else break;
                    }
                    for (; l.length; ) {
                      let [, v] = l[l.length - 1];
                      if (v - c >= m && !h) f = [l.pop(), ...f];
                      else break;
                    }
                    return [l, f];
                  },
      ...
      .pipe(
        u(([s, p]) => ({ prev: s.map(([c]) => c), next: p.map(([c]) => c) })),
        V({ prev: [], next: [] }),
        je(2, 1),
        u(([s, p]) =>
        ...
        i.pipe(
          ...
          if (l.offsetHeight) {
            ...
            if (typeof f != "undefined") {
              let m = l.offsetTop - f.offsetTop,
                { height: d } = be(f);
              f.scrollTo({ top: m - d / 2, behavior: c });
            }
          }
        });
      }
  ...
  function Si(e, { viewport$: t, header$: r, main$: n, target$: o }) {
    ...
    return (
      ...
      Os(e, { viewport$: t, main$: n, target$: o }).pipe(
        w((s) => i.next(s)),
        C(() => i.complete()),
        u((s) => j({ ref: e }, s))
      )
  ...
  function Ti({ document$: e }) {
    e
      .pipe(
        ...
        y((t) => t.offsetWidth < t.scrollWidth),
        re((t) => {
          let r = t.innerText,
            n = t.closest("a") || t;
          return (
  ...
  function _i({ document$: e }) {
    e.pipe(
      g(() => H("[data-md-scrollfix]")),
      w((t) => t.removeAttribute("data-md-scrollfix")),
      y(_s),
      re((t) => b(t, "touchstart").pipe(u(() => t)))
    ).subscribe((t) => {
      let r = t.scrollTop;
      r === 0
        ? (t.scrollTop = 1)
  ...
  function Ms() {
    return location.protocol === "file:"
      ? Er(`${new URL("search/search_index.js", cn.base)}`).pipe(
          u(() => __index),
          Z(1)
        )
      : Ye(new URL("search/search_index.json", cn.base));
  }
  ...
  ee("navigation.instant") &&
    oi({ location$: Nt, viewport$: He }).subscribe(st);
  var Li;
  ((Li = cn.version) == null ? void 0 : Li.provider) === "mike" &&
    li({ document$: st });
  T(Nt, Mt)
    .pipe(Ze(125))
    .subscribe(() => {
      et("drawer", !1), et("search", !1);
    });
  ...
  Ti({ document$: st });
  Oi({ document$: st, tablet$: _r });
  _i({ document$: st });
  Mi({ viewport$: He, tablet$: _r });
  var at = Xo(Ae("header"), { viewport$: He }),
    Dt = st.pipe(
      u(() => Ae("main")),
      g((e) => ti(e, { viewport$: He, header$: at })),
      Z(1)
    ),
    Ls = T(
      ...le("consent").map((e) => Mo(e, { target$: Mt })),
      ...le("dialog").map((e) => Jo(e, { alert$: ln })),
      ...le("header").map((e) =>
        Zo(e, { viewport$: He, header$: at, main$: Dt })
      ),
      ...le("palette").map((e) => ri(e)),
      ...le("search").map((e) => hi(e, { index$: ki, keyboard$: pn })),
      ...le("source").map((e) => xi(e))
    ),
    As = P(() =>
      T(
        ...le("announce").map((e) => _o(e)),
        ...le("content").map((e) =>
          Go(e, { viewport$: He, target$: Mt, print$: Ci })
        ),
        ...le("content").map((e) =>
          ee("search.highlight") ? bi(e, { index$: ki, location$: Nt }) : x
        ),
        ...le("header-title").map((e) => ei(e, { viewport$: He, header$: at })),
        ...le("sidebar").map((e) =>
          e.getAttribute("data-md-type") === "navigation"
            ? Zr(Ai, () => sn(e, { viewport$: He, header$: at, main$: Dt }))
            : Zr(_r, () => sn(e, { viewport$: He, header$: at, main$: Dt }))
        ),
        ...le("tabs").map((e) => Ei(e, { viewport$: He, header$: at })),
        ...le("toc").map((e) =>
          wi(e, { viewport$: He, header$: at, main$: Dt, target$: Mt })
        ),
        ...le("top").map((e) =>
          Si(e, { viewport$: He, header$: at, main$: Dt, target$: Mt })
        )
      )
    ),
    Ri = st.pipe(
